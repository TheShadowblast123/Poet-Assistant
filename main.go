...
func main() {
	...
	http.HandleFunc("/pantoum.html", pantoumHandler)
	http.HandleFunc("/haiku.html", haikuHandler)
	http.HandleFunc("/tanka.html", tankaHandler)
	http.HandleFunc("/cinquain.html", cinquainHandler)
	http.HandleFunc("/villanelle.html", villanelleHandler)
	http.HandleFunc("/sestina.html", sestinaHandler)
	http.HandleFunc("/sonnet.html", sonnetHandler)
